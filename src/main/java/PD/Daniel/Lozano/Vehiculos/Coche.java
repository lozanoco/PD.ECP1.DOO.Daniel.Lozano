...
public class Coche extends Vehiculo {
	...
	public String toString() {
		return "\nTipo: "+ this.getClass().getSimpleName() + " \nid_vehiculo: " +this.getIdVehiculo() + " \ndescripcion: " + this.getDescripcion() + " \ncategoria: " + this.categoria.getNombre_categoria();
	}
	...
	public double calcularAlquiler(int dias) {
		...
		if(dias>DIA_TARIFA_REDUCIDA_2){
			precio = this.categoria.obtenerPrecioCategoria() * (DIA_TARIFA_REDUCIDA_1*FACTOR_TARIFA_NORMAL + (DIA_TARIFA_REDUCIDA_2- DIA_TARIFA_REDUCIDA_1)*FACTOR_TARIFA_REDUCIDA_1 + (dias-DIA_TARIFA_REDUCIDA_2)*FACTOR_TARIFA_REDUCIDA_2); 
		}
